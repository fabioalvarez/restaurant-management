...
// Get mongo collection & instantiate validator
...
func GetFoods() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occurred while listening food items"})
			return
		}
...
func GetFood() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Get parameter from gin context
		foodId := c.Param("foodId")

		// initiate variable with Food model
		var food models.Food

		// Fetch food data using the foodId
